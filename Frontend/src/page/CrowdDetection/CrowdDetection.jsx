...
import style from "./crowdDetection.module.css";
...
const CrowdDetection = () => {
    ...
    useEffect(() => {
        setCameraEvidence(evidence.filter((evi) => evi.crime === "Crowd detected"));
    }, [evidence]);
    ...
    const sendFrameToServer = async () => {
        if (videoRef.current) {
            ...
            await fetch("http://127.0.0.1:5000/crowd-detection", {
                method: "POST",
                body: formData,
            })
    ...
    return (
        ...
        >
            <div className={style.one}>
                <h1 className={style.headline}>Live Crowd Detection</h1>
            </div>
