        ...
        <>
            <header className="bg-red font-[Poppins]">
                <nav className="mt-5 flex justify-between items-center w-[92%] mx-auto">
                    ...
                    <div
                        className={`nav-links duration-500 md:static absolute bg-white md:min-h-full min-h-[60vh] left-0 top-[-100%] md:w-auto  w-full flex items-center px-5 ${isMenuOpen ? 'top-[9%]' : 'top-[-100%]'}
                            `}
                    >
